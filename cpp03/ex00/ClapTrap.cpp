...
ClapTrap::ClapTrap( std::string name ) : _name(name), _health(10), _energy(10), _damage(0) {
    std::cout << this->_name << ": constructor have been called" << std::endl;
}
...
ClapTrap::~ClapTrap() {
    std::cout << this->_name << ": destructor have been called" << std::endl;
}

ClapTrap::ClapTrap( const ClapTrap & src ) {
    *this = src;
    std::cout << this->_name << ": copy constructor have been called" << std::endl;
}
...
ClapTrap & ClapTrap::operator= ( const ClapTrap & src ) {
    ...
    std::cout << this->_name << ": assignation operator have been called" << std::endl;
    return *this;
}
